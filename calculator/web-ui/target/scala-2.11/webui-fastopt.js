...
$c_Lcalculator_Calculator$.prototype.evalF$1__p1__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _evalF: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(a, references) + this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(b, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(a$2, references) - this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(b$2, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(a$3, references) * this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(b$3, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(a$4, references) / this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(b$4, references))
    } else {
...
$c_Lcalculator_Calculator$.prototype.checkRefs$1__p1__Lcalculator_Expr__Lcalculator_Expr__sci_Map__Z = (function(origExpr, expr, references$1) {
  _checkRefs: while (true) {
    var x1 = expr;
    if ((!$is_Lcalculator_Literal(x1))) {
      if ($is_Lcalculator_Ref(x1)) {
        ...
        if (((refExpr === null) ? (origExpr === null) : refExpr.equals__O__Z(origExpr))) {
          return true
        } else {
          expr = refExpr;
          continue _checkRefs
        ...
        var a = x4.a$2;
        var b = x4.b$2;
        if (this.checkRefs$1__p1__Lcalculator_Expr__Lcalculator_Expr__sci_Map__Z(origExpr, a, references$1)) {
          return true
        } else {
          expr = b;
          continue _checkRefs
        ...
        var a$2 = x5.a$2;
        var b$2 = x5.b$2;
        if (this.checkRefs$1__p1__Lcalculator_Expr__Lcalculator_Expr__sci_Map__Z(origExpr, a$2, references$1)) {
          return true
        } else {
          expr = b$2;
          continue _checkRefs
        ...
        var a$3 = x6.a$2;
        var b$3 = x6.b$2;
        if (this.checkRefs$1__p1__Lcalculator_Expr__Lcalculator_Expr__sci_Map__Z(origExpr, a$3, references$1)) {
          return true
        } else {
          expr = b$3;
          continue _checkRefs
        ...
        var a$4 = x7.a$2;
        var b$4 = x7.b$2;
        if (this.checkRefs$1__p1__Lcalculator_Expr__Lcalculator_Expr__sci_Map__Z(origExpr, a$4, references$1)) {
          return true
        } else {
          expr = b$4;
          continue _checkRefs
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return (this.checkRefs$1__p1__Lcalculator_Expr__Lcalculator_Expr__sci_Map__Z(expr, expr, references) ? (NaN) : this.evalF$1__p1__Lcalculator_Expr__sci_Map__D(expr, references))
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var v = $as_T(x0$1.$$und1$f);
    var e = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    ...
    return new $c_T2().init___O__O(v, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
